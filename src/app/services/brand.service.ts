...
export class BrandService {
  ...
  getAll(token: string): Observable<Brand[]>{
    ...
    return this.http.get<Brand[]>('http://localhost:3001/api/brand/getAll',httpOptions);
  }
  ...
  delete(id:number,token:string):Observable<any>{
    ...
    return this.http.delete('http://localhost:3001/api/brand/delete/'+id,httpOptions);
